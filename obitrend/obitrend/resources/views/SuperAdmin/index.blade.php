                                ...
                                <tbody>  @foreach ($users as $row)
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                          ...
                                          <span class="label label-sm label-success"> Super Admin </span>
                                              ...
                                              @elseif($row->access_level==1)
                                                    <a  href="{{ route('super.admin.view') }}" class="btn blue-chambray btn-outline btn-sm">
                                        ...
                                        @if($row->access_level==1)
                                          <a  href="{{ route('demote.admin',$row->id) }}" class="btn blue-chambray btn-outline btn-sm">
                                   <i class="fa fa-trash"></i>
                                   <span class="hidden-xs"> demote</span>
                                   </a>
                                     @elseif($row->access_level==0)
                                   <a  href="{{ route('promote.user',$row->id) }}" class="btn blue-chambray btn-outline btn-sm">
                            <i class="fa fa-trash"></i>
                            <span class="hidden-xs"> promote </span>
                            </a>
                              @endif
