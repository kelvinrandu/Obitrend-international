...
<!-- Mirrored from 7oroof.com/tfdemos/whole/page-about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2017 11:04:10 GMT -->
<head>
<!-- Document Meta
    ============================================= -->
<meta charset="utf-8">
...
<section id="page-title" class="page-title bg-overlay bg-overlay-dark">
	<div class="bg-section" >
		<img src="{{asset('assets/images/page-title/title-2.jpg')}}" alt="Background"/>
	</div>
	<div class="container">
		<div class="row">
